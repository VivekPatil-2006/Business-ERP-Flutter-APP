          ...
          child: Column(
            children: [
              _card('Company & Identity', [
                AppTextField(controller: companyNameCtrl, label: 'Company Name', validator: _required),
                AppTextField(controller: customerCodeCtrl, label: 'Customer Code'),
                AppTextField(controller: ssnCtrl, label: 'Social Security Number'),
                AppTextField(controller: einCtrl, label: 'EIN / TIN'),
                AppTextField(controller: vatCtrl, label: 'VAT Identifier'),
              ]),

              const SizedBox(height: 20),

              _card('Personal & Contact Details', [
                AppTextField(controller: firstNameCtrl, label: 'First Name'),
                AppTextField(controller: lastNameCtrl, label: 'Last Name'),
                AppTextField(controller: contactPersonCtrl, label: 'Contact Person', validator: _required),
                AppTextField(controller: emailCtrl, label: 'Email Address', validator: _required),
                AppTextField(controller: phone1Ctrl, label: 'Phone No 1'),
                AppTextField(controller: phone2Ctrl, label: 'Phone No 2'),
                AppTextField(controller: cellphoneCtrl, label: 'Cellphone'),
                AppTextField(controller: faxCtrl, label: 'Fax No'),
              ]),

              const SizedBox(height: 20),

              _card('Address Details', [
                AppTextField(controller: countryCtrl, label: 'Country'),
                AppTextField(controller: streetCtrl, label: 'Street'),
                AppTextField(controller: cityCtrl, label: 'City'),
                AppTextField(controller: stateCtrl, label: 'State'),
                AppTextField(controller: postcodeCtrl, label: 'Postcode'),
              ]),
